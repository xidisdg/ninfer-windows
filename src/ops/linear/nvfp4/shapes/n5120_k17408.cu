...
using C4        = Nvfp4SimtSchedule<4, 1, 2, 16, 4, 1, Nvfp4SimtActivationAccess::TokenPacked,
                                    Nvfp4ScaleAccess::Direct, Nvfp4CodeCache::Default, 1,
                                    Nvfp4SimtBlockOrder::RowsContiguous, 1>;
using C12       = Nvfp4SimtSchedule<16, 1, 2, 16, 12, 1, Nvfp4SimtActivationAccess::TokenPacked,
                                    Nvfp4ScaleAccess::Direct, Nvfp4CodeCache::Default, 1,
                                    Nvfp4SimtBlockOrder::RowsContiguous, 1>;
...
using C24       = Nvfp4SimtSchedule<4, 1, 2, 16, 24, 1, Nvfp4SimtActivationAccess::TokenPacked,
                                    Nvfp4ScaleAccess::Direct, Nvfp4CodeCache::Default, 1,
                                    Nvfp4SimtBlockOrder::RowsContiguous, 2>;
...
Nvfp4A4Launch select_a4(std::int32_t tokens) {
    if (tokens >= 1024 && tokens % 256 == 0)
        return launch_nvfp4_a4_tma<Nvfp4GeometryId::N5120K17408>;
    if (tokens <= 64) return launch_nvfp4_a4_mma<Geometry, T32R64>;
    if (tokens <= 128) return launch_nvfp4_a4_mma<Geometry, T32R128>;
...
const Nvfp4LinearShape kNvfp4N5120K17408{5120, 17408, launch_nvfp4_a16_chunks<32, select_a16>,
